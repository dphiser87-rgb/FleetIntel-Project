...
// Comparison variant A (mounted at /hero-a): identical to the shipped Hero.jsx, except the boxed
// screenshot on the right is replaced by DashboardMotionGraphic. Keeps the 2-column layout the user
// already chose over a full-bleed background for the static-image version of this same question.
export default function HeroVideoBoxed() {
